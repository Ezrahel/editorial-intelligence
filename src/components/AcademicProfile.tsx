    ...
    <div className="min-h-screen bg-zinc-50 font-sans">
      ...
      <header className="bg-white border-b border-zinc-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex justify-between items-center gap-4">
          <div className="text-lg sm:text-xl font-bold tracking-tighter text-primary font-headline">The Digital Scholar</div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/3 space-y-6">
            <div className="bg-white p-6 sm:p-8 rounded-[2rem] editorial-shadow relative overflow-hidden">
          ...
          {/* Right Content - Form */}
          <div className="lg:w-2/3 bg-white p-6 sm:p-10 md:p-16 rounded-[2rem] editorial-shadow relative">
            {/* Progress */}
            <div className="static sm:absolute sm:top-8 sm:right-12 text-left sm:text-right mb-8 sm:mb-0">
            ...
            <div className="mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold font-headline text-zinc-900">Academic Profile</h2>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Private', 'Federal', 'State'].map((cat) => (
                      <button 
                        key={cat}
                        type="button"
                      className={`px-5 py-3 rounded-xl font-bold text-sm transition-all ${cat === 'Federal' ? 'bg-primary text-white' : 'bg-zinc-100 text-zinc-500 hover:bg-zinc-200'}`}
                      >
                        {cat}
                      </button>
                    ))}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div 
                      key={track.id}
                      className={`p-5 sm:p-6 rounded-2xl border-2 cursor-pointer transition-all flex items-center gap-4 ${track.active ? 'border-primary bg-zinc-50' : 'border-zinc-100 hover:border-zinc-200'}`}
                    >
      ...
      <footer className="max-w-7xl mx-auto px-4 sm:px-8 py-12 border-t border-zinc-200 mt-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-[10px] font-label uppercase tracking-widest text-zinc-400">
