  ...
  <section className="bg-primary py-16 md:py-24 text-center relative overflow-hidden">
    <div className="max-w-3xl mx-auto px-4 sm:px-6 relative z-10">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4">
        <a href="https://ijeshadigitalhub.com/itp" className="inline-flex items-center justify-center bg-white text-primary px-8 md:px-10 py-4 md:py-5 rounded-full font-headline font-bold text-lg md:text-xl hover:bg-zinc-100 transition-colors editorial-shadow">
          Register Now
        </a>
